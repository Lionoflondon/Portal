...
function Vortex({ entries, loading, error, following, onFollow }) {
  ...
  function updateTerm(value) { setTerm(value); if (/^@[a-z0-9_]{3,24}$/i.test(value.trim())) { rememberSearch(value); window.location.hash = publicProfileRoute(value).replace(/^#/, ''); } }
